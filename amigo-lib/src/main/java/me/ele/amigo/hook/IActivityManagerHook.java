...
public class IActivityManagerHook extends ProxyHook {
    ...
    public void onInstall(ClassLoader classLoader) throws Throwable {
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Object gDefault = FieldUtils.readStaticField(cls, "IActivityManagerSingleton");
            if (gDefault == null) {
                ActivityManagerNativeCompat.getService();
                gDefault = FieldUtils.readStaticField(cls, "IActivityManagerSingleton");
            }
            ...
            if (IActivityManagerCompat.isIActivityManager(gDefault)) {
                ...
                Object iam1 = ActivityManagerNativeCompat.getService();
                ...
                Object iam2 = ActivityManagerNativeCompat.getService();
                if (iam1 == iam2) {
                    FieldUtils.writeField(gDefault, "mInstance", object);
                }
                original_gDefault = gDefault;
